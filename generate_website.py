...
def get_database_path(config: configparser.ConfigParser, bot_root: str) -> str | None:
...
def get_command_popularity(db_path: str | None, commands: dict[str, Any]) -> dict[str, int]:
...
def get_channel_info(cmd_instance: Any, monitor_channels: list[str]) -> str | None:
