...
- `generate_website.py` will now include local commands in the generated HTML
  output.
- Disabled commands in the configuration file will not be included in the
  HTML generated by `generate_website.py`.
